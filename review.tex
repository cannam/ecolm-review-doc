...
%  \subsubsection{earlymusiconline.org}
  ...
  \begin{figure}[h]
  \centering
  \caption{ECOLM II database schema (main tables)}
...
%  \begin{figure}[p]
%  \centering
%  \caption{ECOLM II database schema: Administrative and unreferenced tables}
%  \includegraphics[width=\columnwidth]{plot/admin}
%  \label{fig:admin}
%  \end{figure}
  ...
  \begin{figure}[p]
  \centering
  \caption{RISM Muscat application schema summary}
